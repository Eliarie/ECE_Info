...
export const UI_TEXT = {
  zh: {
    ...
    digestResult: '结论',
    digestCore: '核心',
    digestInterestPlaceholder: '输入兴趣，生成专属概览，如：AI和教育',
    digestInterestGenerate: '生成',
    digestInterestClear: '清除',
    digestGenerating: '正在生成…',
    digestInterestError: '生成失败，请稍后重试。',
    digestInterestSectionTitle: (interest: string) => `关于「${interest}」`,
  },
  en: {
    ...
    digestCore: 'Focus',
    digestInterestPlaceholder: 'Enter an interest to generate your overview, e.g. AI and education',
    digestInterestGenerate: 'Generate',
    digestInterestClear: 'Clear',
    digestGenerating: 'Generating…',
    digestInterestError: 'Generation failed. Please try again.',
    digestInterestSectionTitle: (interest: string) => `About "${interest}"`,
  },
} as const
